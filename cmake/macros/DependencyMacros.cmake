...
set(DEP_ABUILD_MISC "MACIS" "MSGSL" "NJSON" "DOCTEST" "SPDLOG" "EcpInt" "Librett" "CUTLASS" "NWQSim")
...
function(cmsb_find_dependency __name)
    ...
    elseif(${__name} STREQUAL "NWQSim")
      set(_dep_name nwqsim)
    elseif(${__name} STREQUAL "CUTLASS")
      set(_dep_name NvidiaCutlass)      
    endif()
    if(${__name} IN_LIST DEP_ABUILD_MISC)
      ...
      elseif(${__name} STREQUAL "CUTLASS")
        set(__dep_target_name nvidia::cutlass::cutlass)
      endif()
    endif()
