...
function(build_cmsb_module SUPER_PROJECT_ROOT)
    ...
    set(CMSB_CORE_OPTIONS CMAKE_CXX_COMPILER CMAKE_C_COMPILER SUPER_PROJECT_BINARY_DIR
        CMAKE_Fortran_COMPILER CMAKE_BUILD_TYPE BUILD_SHARED_LIBS ${CMSB_C_FLAGS} ${CMSB_CXX_FLAGS} ${CMSB_Fortran_FLAGS} CMAKE_POLICY_VERSION_MINIMUM
    ...
    bundle_cmake_args(DEPENDENCY_CMAKE_OPTIONS BLAS_INT4 LINALG_VENDOR LINALG_PREFIX ENABLE_COVERAGE USE_SCALAPACK USE_HDF5 USE_LIBNUMA USE_ONEMATH_CUDA USE_ONEMATH_HIP ONEMATH_PREFIX USE_NWQSIM)
    ...
    bundle_cmake_strings(CORE_CMAKE_STRINGS USE_UPCXX LINALG_PREFIX USE_SCALAPACK USE_HDF5 USE_LIBNUMA USE_NWQSIM LINK_STATIC_GPU_LIBS)
    bundle_cmake_strings(CORE_CMAKE_STRINGS ${PROJECT_NAME}_HAS_HIP CMSB_HAS_HIP ROCM_ROOT)
    bundle_cmake_strings(CORE_CMAKE_STRINGS ${PROJECT_NAME}_HAS_DPCPP CMSB_HAS_DPCPP USE_ONEMATH_CUDA USE_ONEMATH_HIP ONEMATH_PREFIX)
