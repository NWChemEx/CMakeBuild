...
function(cmsb_set_up_target __name __flags __lflags __install)
    ...
    if(${CMSB_PROJECTS}_HAS_HIP)
      ...
      set(_GPU_BLAS roc::rocblas roc::rocsolver hip::device rocm_smi64)
    ...
    elseif(${CMSB_PROJECTS}_HAS_CUDA)
      ...
      if(NOT LINK_STATIC_GPU_LIBS)
        target_link_libraries(${__name} PUBLIC CUDA::cudart CUDA::cublas CUDA::cublasLt CUDA::cusolver CUDA::nvml)
      else()
        target_link_libraries(${__name} PUBLIC CUDA::cudart_static CUDA::cublas_static CUDA::cublasLt_static CUDA::cusolver_static CUDA::nvml)
      endif()
    ...
    elseif(${CMSB_PROJECTS}_HAS_DPCPP)
      ...
      if(USE_ONEMATH)
        ...
        target_link_libraries(${__name} PUBLIC MKL::MKL_SYCL::BLAS MKL::MKL_SYCL::LAPACK)
      endif()      
    endif()
endfunction()
