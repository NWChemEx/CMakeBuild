...
is_valid_and_true(GAUXC_URL __set)
if (NOT __set)
  set(GAUXC_URL "https://github.com/wavefunction91/GauXC.git")
endif()

is_valid_and_true(GAUXC_TAG __set)
if(__set)
...
if(GAUXC_GPU)
    ...
    if(${CMSB_PROJECTS}_HAS_DPCPP)
      set(_CMSB_GAUXC_ENABLE_DPCPP -DGAUXC_ENABLE_SYCL=${${CMSB_PROJECTS}_HAS_DPCPP} -DGAUXC_SYCL_TARGET=${GPU_ARCH})
    endif()    
...
message(STATUS "GauXC OPTIONS: -DGAUXC_ENABLE_TESTS=OFF ${GAUXC_LINK_STATIC} \
 ${_CMSB_GAUXC_ENABLE_CUDA} ${_CMSB_GAUXC_ENABLE_HIP} ${_CMSB_GAUXC_ENABLE_DPCPP} -DGAUXC_ENABLE_HOST=ON \
...
set(GAUXC_CXX_FLAGS_INIT "-DOMPI_SKIP_MPICXX -Wno-missing-braces")

ExternalProject_Add(GauXC_External
    GIT_REPOSITORY ${GAUXC_URL}
    GIT_TAG ${GXC_GIT_TAG}
    UPDATE_DISCONNECTED 1
    CMAKE_ARGS ${DEPENDENCY_CMAKE_OPTIONS} -DCMAKE_CXX_FLAGS_INIT=${GAUXC_CXX_FLAGS_INIT} -DGAUXC_ENABLE_TESTS=OFF 
